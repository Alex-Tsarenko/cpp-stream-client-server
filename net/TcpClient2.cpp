...
//// TcpClient
//class TcpClient2 : public ITcpClient
//{
...
//public:
//    TcpClient2() :m_context(), m_socket(m_context)
//    {
//    }
//    ~TcpClient2()
//    {
//        LOG( "~TcpClient2()" << std::endl );
//    }
...
//std::unique_ptr<ITcpClient> createTcpClient0()
//{
//    return std::unique_ptr<ITcpClient>( new TcpClient2() );
//}
